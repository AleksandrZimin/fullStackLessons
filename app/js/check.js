...
btnForm.onclick = function() {
   ...
   if(form.name.value.length < 4) {
      ...
      document.querySelector("#error").innerHTML = "Длина имени не более 20 символов";
      return false;
   } else if(form.comment.value.length < 10) {
      document.querySelector("#error").innerHTML = "Длина комментария не менее 10 символов";
      return false;
   } else if(form.comment.value.length > 200) {
      document.querySelector("#error").innerHTML = "Длина комментария не более 200 символов";
      return false;
   }
